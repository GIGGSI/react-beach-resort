        ...
        <section className="section ">
            ...
            <div className="about-center section-center">
                ...
                <article className="about-info">
                    ...
                    <p>Sed semper orci sit amet porta placerat. Etiam quis finibus eros. Sed aliquam metus lorem, a pellentesque tellus pretium a. Nulla placerat elit in justo vestibulum, et maximus sem pulvinar  
                    </p>
